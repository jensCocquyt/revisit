# cloud-demo Specification

## Purpose
The scripted contract-v2 demo against the cloud URL and the Bruno cloud environment, including terminal failure and runbook recovery.
