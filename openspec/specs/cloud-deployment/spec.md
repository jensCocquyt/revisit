...
## Purpose
The Terraform-provisioned AWS demo environment: durable bootstrap root plus ephemeral stack root, least-privilege runtime identities, cost-disciplined networking, and the destroy/apply round-trip guarantee.
